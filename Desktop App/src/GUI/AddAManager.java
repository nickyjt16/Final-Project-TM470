...
public class AddAManager extends javax.swing.JFrame {
    ...
    private void btnSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSaveMouseClicked
        try {
            ...
            PreparedStatement st = vConnection.prepareStatement("insert into MANAGERS(id, name, mobileNumber, carReg, nextOfKin, nextOfKinPhone) values (?,?,?,?,?,?)");
            st.setString(1, id);
            st.setString(2, name);
            ...
            if (a > 0) {
                txtAddManagerOutcome.setText((String)name + " has been added, you may \n"
                    + "now add another manager or close this screen by clicking Return");
                txtId.setText("");
                txtName.setText("");
